...
class CommnetTrainer(Trainer):
    def __init__(self, name, n, obs_shape, act_space, args, **kwargs):
        ...
        actor_network_class = CommNetNoTanh if kwargs['pub'] == 'A' else actor_network_class
        actor_network_class = CommNetScalar if kwargs['pub'] == 'B' else actor_network_class
        actor_network_class = CommNetVector if kwargs['pub'] == 'C' else actor_network_class
